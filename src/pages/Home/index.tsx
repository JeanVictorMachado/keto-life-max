  ...
  return (
    <div className="home-comtainer">
      ...
      <div className="home-content">
        ...
        <p id="home-content__call-method" className="home-content__call-method">
        ...
        <p className="home-content__objetive-text">
          Você será capaz de atingir todos seus objetivos com o metodo Keto PRO
        </p>
        ...
        <div className="home-content__perfil-icon">
          ...
          <p className="home-content__perfil-text">
            Imediatamente após preencher as suas informações no questionário,
            verá o seu Índice de Massa Corporal (IMC) pessoal e idade
            metabólica. Obtenha também recomendações sobre a ingestão diária de
            calorias e água. Tudo isso de graça.
          </p>
        </div>
        ...
        <div className="home-content__book-icon">
          ...
          <p className="home-content__perfil-text">
            Veja uma vídeo aula grátis criada por um nutricionista experiente e
            pós graduado em emagrecimento de forma saudável, entenda tudo como
            funciona o metodo Keto PRO e o por que ele é tudo eficaz na perda de
            peso.
          </p>
        </div>
