    ...
    <>
      ...
      <div className="terms-of-use__content">
        ...
        <p>
          ...
          materiais (informações ou software) no site Keto PRO , apenas para
        ...
        <p>
          ...
          dessas restrições e poderá ser rescindida por Keto PRO a qualquer
        ...
        <ol>
          {" "}
          <li>
            Os materiais no site da Keto PRO são fornecidos 'como estão'. Keto
          ...
          <li>
            Além disso, o Keto PRO não garante ou faz qualquer representação
        ...
        <p>
          Em nenhum caso o Keto PRO ou seus fornecedores serão responsáveis
          ...
          uso ou da incapacidade de usar os materiais em Keto PRO, mesmo que
          Keto PRO ou um representante autorizado da Keto PRO tenha sido
        ...
        <p>
          Os materiais exibidos no site da Keto PRO podem incluir erros
          técnicos, tipográficos ou fotográficos. Keto PRO não garante que
          ...
          qualquer momento, sem aviso prévio. No entanto, Keto PRO não se
          compromete a atualizar os materiais.
        </p>
        <h2 className="terms-of-use__title">6. Links</h2>{" "}
        <p>
          O Keto PRO não analisou todos os sites vinculados ao seu site e não é
          responsável pelo conteúdo de nenhum site vinculado. A inclusão de
          qualquer link não implica endosso por Keto PRO do site. O uso de
          qualquer site vinculado é por conta e risco do usuário.
        </p>
        <h3>Modificações</h3>{" "}
        <p>
          O Keto PRO pode revisar estes termos de serviço do site a qualquer
        ...
        <p>
          ...
          leis do Keto PRO e você se submete irrevogavelmente à jurisdição
