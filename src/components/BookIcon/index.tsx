...
export const BookIcon = ({ width }: BookIconProps) => {
  return (
    <div
      style={{
        width,
    ...
    >
      ...
      >
        <linearGradient
          ...
          y2="100"
        >
          <stop offset="0" className="book-icon__2"></stop>
          <stop offset="1" className="book-icon__3"></stop>
        </linearGradient>
        <linearGradient
          id="Read_2_"
          gradientUnits="userSpaceOnUse"
        ...
        <path
          className="book-icon__4"
          id="Read"
          d="M198.1,119.2c0-5-4-9-9-9c-1.8,0-3.5,0.5-4.9,1.5c-0.5-1.2-1.3-2.2-2.3-3.1V29.9
